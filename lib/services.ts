...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    points: [
      "Gas, oil, combi, and condensing boilers",
      "Hydronic radiant heat systems",
      "No-heat emergency repair 24/7",
      "Pressure loss and leak diagnosis",
      "Annual boiler servicing and tune-ups",
      "Zone valve, pump, and control repairs",
    ],
    whatWeDo: [
      { title: "No-Heat Diagnosis", desc: "We find the actual root cause — ignition, pump, control board, or pressure — before quoting." },
      { title: "Pressure and Leak Repair", desc: "Pressure loss means a leak somewhere. We locate it and fix it rather than just refilling." },
      { title: "Descaling and Power Flush", desc: "Kettling and banging in Niagara hard water usually means scale. A flush restores efficiency." },
      { title: "Pump and Zone Valve Service", desc: "Circulator pumps and zone valves replaced with common parts stocked on the truck." },
      { title: "Annual Boiler Service", desc: "Heat exchanger cleaning, safety control testing, flue check, and radiator bleeding." },
      { title: "24/7 Emergency Response", desc: "No-heat boiler calls dispatched any hour, any day, across the Niagara Region." },
    ],
    whyUs: [
  ...
  },
  {
    ...
    points: [
      ...
      "Central air conditioning install and replacement",
      "AC repair, refrigerant service, and coil cleaning",
      "Hybrid heat pump plus furnace systems",
      "Annual cooling season tune-ups",
    ],
    whatWeDo: [
      { title: "Heat Load Calculation", desc: "We size the system to your actual home, not a rule of thumb — oversized units short-cycle and fail early." },
